...
@Component
public class Varasto implements Halli {
    @Autowired
    private Organisoija organisoija;
    private HashMap<Tuote, Integer> saldot;  
    
    public Varasto(Organisoija organisoija) {
    ...
    public void otaVarastosta(Tuote t){        
        ...
        organisoija.lisaaTapahtuma("otettiin varastosta "+t);
    }
    
    @Override
    public void palautaVarastoon(Tuote t){
        saldot.put(t,  saldo(t.getId())+1 );
        organisoija.lisaaTapahtuma("palautettiin varastoon "+t);
    }    
